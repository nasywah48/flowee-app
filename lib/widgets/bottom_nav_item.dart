        ...
        child: Row(
          ...
          children: [
            ...
            AnimatedSize(
              ...
              curve: Curves.easeOut,
              child: selected 
                  ? Padding(padding: EdgeInsetsGeometry.only(left: 8),
                  child: Text(
                    label,
                    style: TextStyle(
              ...
              : SizedBox.shrink()
            ) // menganimasikan ukuran childnya, disini digunakan supaya label muncul dengan animasi "melebar" awalnya lebarnya 0 BUKAN LANCUNG MUNCUL TIBA TIBA
          ],
        ),
      ),
    );
